...
const books: Book[] = [
  ...
  },
  {
    ...
    synopsis: 'Our emotions influence our responses and subsequent reactions to change or to life’s experiences. For a lot of us, our formal and informal education systems did not provide the skills to navigate the changes and challenges we encounter in life. The good thing, though, is that we can still learn it along the way, at whatever stage we are in life. I experienced this kind of learning on the Nile River—rafting without prior knowledge but with willingness to learn, change the status quo, practice, become better, and be flexible enough to let adventure in. I was a mediocre paddler, and I didn’t know how to swim—but I was willing to learn. It is out of that adventure that I can reflect on the metaphor of a river as our daily life. The key lessons I took from the river raft that I have seen as key in learning and applying emotional intelligence in our lives for overall success covered in this book are: Know your course. Stay present. Don’t give power to external conditions. Adapt purposely. Have some tools and options. Team with people who are creating the results that you want. Don’t flow back on yourself: Get out of obstructions as soon as possible—your whole life still awaits you! Recharge. Flow on purpose and live. Celebrate the unsung hero inside you.',
    year: '2018',
  ...
  },
  {
    ...
    synopsis: 'In this book, author and Behavioural Science Specialist Dr Mavis Mazhura (Mavis Ureke) combines personal experience and an in-depth understanding of human emotions to give you the necessary information to create the life you want, and this she does by teaching you how to harness and utilize your own creative tools in the form of emotions and thoughts. As Mavis so clearly explains, you are not doomed financially by your biology, circumstances or geography, and by merely raising your level of awareness and mastering your emotions you will thereby raise your financial results. Money is not discriminatory, you just have to understand the rules of manifestation: that our emotions are anchors of thoughts and the invisible forces that create our financial results. This book shows you that your financial results may be sabotaged by any lingering emotions from the past, hence the need to use the tools that she teaches to neutralize any negative cellular memory, rescript and rewrite new memories that support your financial goals by raising your level of awareness. Through her powerful workshops, thousands of people across Africa have achieved their emotional emancipation, leading to accelerated financial results. If you apply what you learn here, you too can change your results in the key areas of your life, including – and especially – money.',
    year: '2015',
  ...
  },
  {
    ...
    amazonUrl: '#',
    synopsis: 'The change is a personal development book written by 20 different authors from across the globe including Mavis. The Change book will help you let go of the baggage you been carrying around for years and learn to embrace everything that creates the future you want and deserve. You will gain a new life of super focus as never before and you will commence to master manifest in your own individual life as never before. The Change books provide tools to transform results for corporations, institutions and individuals, and once applied it will be impossible to miss your future success in life. Topics include: Resolving Conflict in Relationships, The Power of Emotional Expectation, The Power of Surrender, Body Wisdom, Choice: Its Much More PowerFul Than You May Think. Its the KEY, Understanding and Healing Emotional Pain, If I can Heal my Heart so Can You, From Awareness to Transformation and many others.',
  ...
  },
  {
    ...
    synopsis: 'Resilience is one of the current watchwords in the era of accelerated change with rapid technological advancement and digitisation. At an organisational level it can be looked at as the systems, processes and people resilience. And at a personal level it is the ability to adapt to these changes without brittleness in the key domains of life, that is resilient relationships, career resilience and physical and health resilience. The focus of this book is Career Resilience to maintain your wellbeing.',
    year: '2020',
  ...
  },
  {
    ...
    amazonUrl: '#',
    synopsis: 'The heart is the seat of emotions, often receiving information from the outside world to process. However not all information is useful to protect our emotional states, so heart boundaries is a book sharing ways to guard your own heart by establishing boundaries.',
